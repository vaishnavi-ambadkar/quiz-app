...
// Function to insert questions (Only run this once, then comment it out)
const insertQuestions = async () => {
  const questions = [
    { id: "q1", text: "What comes next in the sequence: 1, 4, 9, 16, __?", answers: ["20", "25", "30"], correct: "25" },
    { id: "q2", text: "A clock shows 3:15. What is the angle between the hour and minute hands?", answers: ["30°", "7.5°", "12°"], correct: "7.5°" },
...
// ⚠️ Uncomment the below line ONLY ONCE to insert questions, then comment it again
// insertQuestions();

// Routes
app.get("/", (req, res) => {
    res.json({ message: "Hello, your backend is running on Vercel! 🚀" });
});
...
// Start the server (Only needed locally, Vercel handles it automatically)
